...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_CAT = 4,                      /* T_CAT  */
  YYSYMBOL_T_ECHO = 5,                     /* T_ECHO  */
  YYSYMBOL_T_HELP = 6,                     /* T_HELP  */
  YYSYMBOL_T_CLEAR = 7,                    /* T_CLEAR  */
  YYSYMBOL_T_EOL = 8,                      /* T_EOL  */
...
{
       0,   157,   157,   157,   158,   158,   160,   161,   162,   163
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_CAT", "T_ECHO", "T_HELP", "T_CLEAR", "T_EOL", "$accept", "input",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* command: T_CAT T_IDENTIFIER  */
#line 160 "parser.y"
                         { handle_section_command((yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1212 "parser.tab.c"
    break;

  case 7: /* command: T_ECHO T_IDENTIFIER  */
#line 161 "parser.y"
                          { handle_section_command((yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1218 "parser.tab.c"
    break;

  case 8: /* command: T_HELP  */
#line 162 "parser.y"
             { safe_strncat("\n--- Portfolio Terminal Help ---\nUsage: cat [section]\n\nAvailable commands:\n  cat, echo        Display content of a section.\n  help             Show this help message.\n  clear, cls       Clear the terminal screen.\n\nAvailable sections:\n  - about\n  - projects\n  - skills\n  - experience\n  - education\n  - awards\n  - contact\n"); }
#line 1224 "parser.tab.c"
    break;

  case 9: /* command: T_CLEAR  */
#line 163 "parser.y"
              { strncpy(output_buffer, "COMMAND_CLEAR", OUTPUT_BUFFER_SIZE); }
